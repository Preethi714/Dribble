  ...
  <div class="row g-4">
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="bail.jpeg" class="card-img-top" alt="Bali">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="pariss.jpeg" class="card-img-top" alt="Paris">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="swiss.jpeg" class="card-img-top" alt="Swiss Alps">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="peru.webp" class="card-img-top" alt="Machu Picchu">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="dubai.jpeg" class="card-img-top" alt="Dubai">
        <div class="card-body">
...
<footer class="mt-5">
  <h2 style="background-color: #1a3635; color: white; text-align: center; font-size: 18px; font-family: 'Trebuchet MS', sans-serif;">
    Designed and developed by Preethi.K
  </h2>
</footer>
...
![alt text](<Screenshot 2025-11-17 094111.png>)
